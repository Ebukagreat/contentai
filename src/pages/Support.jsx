...
const S = {
  ...
  title: { fontSize:28, fontWeight:700, color:'#FAF6ED', letterSpacing:'-0.5px', marginBottom:'0.5rem', fontFamily:"'Space Grotesk',sans-serif" },
  lead: { fontSize:14, color:'#C5D0C7', lineHeight:1.8, marginBottom:'2rem' },
  contactCard: { background:'#142016', border:'1px solid #24372A', borderRadius:8, padding:'1.25rem', marginBottom:'2.5rem', borderLeft:'3px solid #FF6B35' },
  contactTitle: { fontSize:15, fontWeight:700, color:'#FAF6ED', marginBottom:2, fontFamily:"'Space Grotesk',sans-serif" },
  contactSub: { fontSize:12, color:'#9AAB9C', marginBottom:6 },
  contactEmail: { color:'#FF6B35', fontSize:14, textDecoration:'none', fontWeight:600 },
  h2: { fontSize:18, fontWeight:700, color:'#FAF6ED', marginBottom:'1rem', fontFamily:"'Space Grotesk',sans-serif" },
  faqList: { display:'flex', flexDirection:'column', gap:8 },
  faqItem: { background:'#142016', border:'1px solid #24372A', borderRadius:6, padding:'14px 16px', cursor:'pointer' },
  faqQ: { display:'flex', justifyContent:'space-between', alignItems:'center', gap:12, fontSize:14, color:'#FAF6ED', fontWeight:500 },
  faqA: { fontSize:13, color:'#C5D0C7', lineHeight:1.7, marginTop:10, paddingTop:10, borderTop:'1px solid #24372A' },
  footer: { display:'flex', gap:20, marginTop:'3rem', paddingTop:'1.5rem', borderTop:'1px solid #24372A' },
  footLink: { fontSize:13, color:'#6B8070', textDecoration:'none' },
}
