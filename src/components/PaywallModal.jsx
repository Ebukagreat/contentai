...
const S = {
  ...
  modal: { background:'#141C0F',border:'1px solid #2A3621',borderRadius:12,padding:'2rem',maxWidth:480,width:'100%',position:'relative',fontFamily:"'Inter',sans-serif" },
  closeBtn: { position:'absolute',top:16,right:16,background:'#1F2B1A',border:'none',color:'#7C8170',borderRadius:5,width:26,height:26,cursor:'pointer',fontSize:12 },
  ...
  title: { fontSize:19,fontWeight:700,color:'#F4EBD9',marginBottom:6,fontFamily:"'Space Grotesk',sans-serif" },
  sub: { fontSize:13,color:'#7C8170',marginBottom:'1.5rem' },
  grid: { display:'grid',gridTemplateColumns:'1fr 1fr',gap:12,marginBottom:'1.25rem' },
  planCard: { border:'1px solid #1F2B1A',borderRadius:8,padding:'1rem',cursor:'pointer',position:'relative',background:'#0D140A' },
  planSel: { border:'1px solid #FF6B35',background:'#1A2515' },
  popBadge: { position:'absolute',top:-9,left:'50%',transform:'translateX(-50%)',background:'#FF6B35',color:'#11190F',fontSize:10,fontWeight:700,padding:'2px 10px',borderRadius:99,whiteSpace:'nowrap' },
  planName: { fontSize:14,fontWeight:700,color:'#F4EBD9',marginBottom:4,fontFamily:"'Space Grotesk',sans-serif" },
  planPrice: { fontSize:19,fontWeight:800,color:'#FF6B35',marginBottom:10,fontFamily:"'Space Grotesk',sans-serif" },
  list: { listStyle:'none',padding:0,margin:0 },
  li: { fontSize:12,color:'#A8AC9E',marginBottom:4,display:'flex',gap:6,alignItems:'flex-start' },
  check: { color:'#FF6B35',flexShrink:0 },
  payBtn: { width:'100%',padding:13,background:'#FF6B35',color:'#11190F',border:'none',borderRadius:6,fontSize:14,fontWeight:700,cursor:'pointer',fontFamily:"'Inter',sans-serif" },
  secure: { textAlign:'center',fontSize:12,color:'#4A5240',marginTop:10 },
}
